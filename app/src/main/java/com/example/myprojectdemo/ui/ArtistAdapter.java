...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.myclass>  {
    ...
    public ArtistAdapter(Context context, ArrayList artistModels) {
    ...
    public void onBindViewHolder(@NonNull myclass holder, int position) {
        ...
        holder.cd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               Intent intent = new Intent(context, ViewTrackListActivity.class);
